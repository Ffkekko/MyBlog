...
/* export const SELLER_REVIEW_SAVE_REQUEST = 'SELLER_REVIEW_SAVE_REQUEST';
export const SELLER_REVIEW_SAVE_SUCCESS = 'SELLER_REVIEW_SAVE_SUCCESS';
export const SELLER_REVIEW_SAVE_FAIL = 'SELLER_REVIEW_SAVE_FAIL'; */
