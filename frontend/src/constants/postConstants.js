...
export const POST_COMMENT_SAVE_REQUEST = 'POST_COMMENT_SAVE_REQUEST';
export const POST_COMMENT_SAVE_SUCCESS = 'POST_COMMENT_SAVE_SUCCESS';
export const POST_COMMENT_SAVE_FAIL = 'POST_COMMENT_SAVE_FAIL';
export const POST_COMMENT_SAVE_RESET = 'POST_COMMENT_SAVE_RESET';
